...
func TestStringers(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			want: "{MaxBytes: 1024, MaxRequests: unlimited, DefaultRequestTTL: 30s, PriorityBands: [{Priority: 10, MaxBytes: 512, RejectOnGlobalSaturation: true}], SaturationDetector: {PluginRef: test-plugin}}",
		},
		{
